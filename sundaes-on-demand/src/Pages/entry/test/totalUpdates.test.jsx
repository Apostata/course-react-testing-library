...
describe('subtotals', ()=>{
    ...
    describe('toppings Subtotals', ()=>{
        test('update toppgins subtotal when toppgins change', async()=>{
            ...
            const toppginsSubtotal = screen.getByText('Toppings total: $', {exact:false}) //partial match
...
describe('Grand Total', ()=>{
    test('Grand total starts at $0.00', async()=>{
        render(<OrderEntry/>, {wrapper:WhithAllProviders})
        const grandTotal = screen.getByRole('heading', {name:/grand total: \$/i})
        await waitFor(()=>{ // apesar de o do grandTotal ser syncrono, o componente Order entry carrega Options para scoops e toppings asyncrono é necessário que seja asyncrono
