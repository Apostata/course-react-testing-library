...
describe("Sumary form", () => {
  describe("Initial render", () => {
    test("Terms and conditions checkbox, should initialize unchecked", () => {
      render(<SummaryForm />, {
        wrapper: OrderDetailsProvider as ComponentType<{}>,
      });
      const termsAndConditions = screen.getByRole("checkbox", {
        name: termsAnConditionsText,
      });
  ...
  describe("Events", () => {
    ...
    test("Povover appers when mouseover on checkbox label, and disapears when mouseout", async () => {
      ...
      const termsAndConditionsPopoverText = screen.getByText(
        termsAnConditionsText
      );
